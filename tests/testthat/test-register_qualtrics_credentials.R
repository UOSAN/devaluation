test_that("Returns proper errors.", {
  expect_error(register_qualtrics_credentials(path_to_creds = ""), "A credentials file does not exist at that path.")
  ...
  expect_error(register_qualtrics_credentials(path_to_creds = ""),
